...
namespace Entidades
{
    ...
    public class Local<T> where T : Instrumento
    {
        ...
        /// <summary>
        /// Recibe un local y una lista, analiza si lo elementos que se encuentran en la lista, ya estan en el local.
        /// </summary>
        /// <param name="local"></param>
        /// <param name="lista"></param>
        /// <returns></returns>
        public static Local<T> operator +(Local<T> local, List<T> lista)
        {
            ...
            local.eventoCargaError("No se pudieron cargar todos los elementos",EventArgs.Empty);
            return local;
        }
